      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-finance-lightText mb-2">No insights available</p>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-green-50 p-4 rounded-lg">
            ...
            <div className="text-xs text-green-600 mt-1">
              {selectedCategory ? selectedCategory : "All budgets"}
            </div>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between text-xs text-finance-lightText mt-1 gap-1">
        ...
        {insights.categoriesOverBudget > 0 && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <p className="text-red-700 text-sm">
              You have exceeded the budget in {insights.categoriesOverBudget}
              {insights.categoriesOverBudget === 1
                ? " category"
                : " categories"}{" "}
              this month.
            </p>
        ...
        {filteredBudgetComparison && filteredBudgetComparison.length > 0 && (
          <div className="mb-6">
            <h4 className="font-medium text-finance-lightText mb-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {filteredBudgetComparison.map((category) => (
                <div
                  ...
                  className="bg-gray-50 text-black p-3 rounded-lg border"
                >
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            ...
            {insights.categoriesOverBudget === 0 && budgetUtilization < 80 && (
              <li>
            ...
            {budgetUtilization > 50 && budgetUtilization < 80 && (
              <li>
                • You're on track with your spending. Consider setting aside the
